 ...
 ╲           ╱
  ╰─────────╯</div>
    ...
    private fun buildThemeVars(): Map<String, String> {
        ...
        // Warm Ember design system colours
        return buildMap {
            // Primary colours — extracted from IntelliJ theme with Warm Ember fallbacks
            put("--app-primary-foreground", resolveColor("Label.foreground", isDark, "#E8E0D8", "#2A2420"))
            put("--app-primary-background", resolveColor("SidePanel.background", isDark, "#1A1A1E", "#FAF8F5"))
            put("--app-secondary-foreground", resolveColor("Label.disabledForeground", isDark, "#9A9490", "#8A7E74"))
            put("--app-secondary-background", resolveColor("Editor.background", isDark, "#242428", "#ffffff"))
            put("--app-input-background", resolveColor("TextField.background", isDark, "#242428", "#ffffff"))
            put("--app-input-border", resolveColor("Component.borderColor", isDark, "#3A3A40", "#DDD8D0"))
            put("--app-input-active-border", resolveColor("Component.focusedBorderColor", isDark, "#E8734A", "#D4623A"))
            put("--app-tool-background", resolveColor("Editor.background", isDark, "#242428", "#ffffff"))
            put("--app-button-background", resolveColor("Button.default.startBackground", isDark, "#E8734A", "#D4623A"))
            put("--app-button-foreground", resolveColor("Button.default.foreground", isDark, "#FAF8F5", "#ffffff"))
            put("--app-error-foreground", resolveColor("Label.errorForeground", isDark, "#E06C75", "#C62828"))
            put("--app-success-foreground", "#6ECB8B")
            put("--app-warning-accent", "#E5C07B")
            put("--app-status-busy", "#6ECB8B")
            put("--app-status-pending", "#7CB3D4")
            put("--app-claude-orange", "#E8734A")
            put("--app-spinner-foreground", if (isDark) "#E8734A" else "#D4623A")
            put("--app-primary-border-color", resolveColor("Borders.color", isDark, "#3A3A40", "#DDD8D0"))
            put("--app-link-color", resolveColor("Link.activeForeground", isDark, "#7CB3D4", "#D4623A"))
            put("--app-transparent-inner-border", if (isDark) "rgba(232,224,216,0.1)" else "rgba(42,36,32,0.07)")
            put("--app-ghost-button-hover-background", if (isDark) "rgba(58, 58, 64, 0.4)" else "rgba(42, 36, 32, 0.07)")
            put("--app-menu-background", resolveColor("PopupMenu.background", isDark, "#242428", "#FAF8F5"))
            // Warm Ember vars
            put("--app-claude-clay-button-orange", if (isDark) "#E8734A" else "#BF5530")
            put("--app-claude-ivory", "#FAF8F5")
            put("--app-input-secondary-background", resolveColor("PopupMenu.background", isDark, "#242428", "#FAF8F5"))
            put("--app-header-background", resolveColor("SidePanel.background", isDark, "#1A1A1E", "#FAF8F5"))
            put("--app-list-hover-background", if (isDark) "rgba(58, 58, 64, 0.4)" else "rgba(42, 36, 32, 0.07)")
            put("--app-list-active-background", resolveColor("Button.default.startBackground", isDark, "#E8734A", "#D4623A"))
            put("--app-progressbar-background", "#6ECB8B")
            // Scrollbar
            put("--scrollbar-thumb", if (isDark) "#4A4A50" else "#C8C0B8")
